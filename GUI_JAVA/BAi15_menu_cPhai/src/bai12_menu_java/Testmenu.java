...
// tao 1 jframe hien thi 
	public Testmenu() {
		...
		menu_hieu.addSeparator();
		menu_hieu.add(love);
		Menu_actionlistener actionlistener = new Menu_actionlistener(this);
		...
		jCheckBoxMenuItem_toolbar.addActionListener(actionlistener);
		// tao menu them!
	...
	public void hienthi_jtoolbar() {
		this.add(jtoolbar, BorderLayout.NORTH);
		this.refresh();
	}
	public void tat_jtollbar() {
