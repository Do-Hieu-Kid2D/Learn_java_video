...
public class QLSVView extends JFrame {
	...
	public QLSVView() {
		...
		Action action = new Controller.QLSVController(this);
	...
	public void thucHienTim() {
		...
		Set idCuaThiSinhCanXoa = new TreeSet();
		if (queQuan >= 0) {
	...
	public void thucHienTaiLaiDuLieu() {
		...
		for (ArrayList<ThiSinh> ts : this.model.getDsThiSinh()) {
			this.themThiSinhVaoTable(ts);
		}
	}
